        ...
        <div className={style.wrapper}>
            <div className={style.container}>
                    <ul className={style.ul}>
                        <li className={style.li}><Link className={style.a} to={'ChoosingFranchise-modal'} data-text="Изучай"><img className={style.img} alt={'img_unsplash'} src={'https://lifemoneyblog.ru/wp-content/uploads/2022/03/franchiz2-scaled.jpg'}/>Франчайзинг</Link></li>
